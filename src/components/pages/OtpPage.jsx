  ...
  <MdOutlineMobileFriendly size={40} className="text-blue-900" />
    ...
    <div className='flex flex-col items-center gap-6'>
     ...
     <ToastContainer autoClose={2000}/>
      {loader && <svg aria-hidden="true" class="items-center inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-pink-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
