...
const OtpPage = () => {
  ...
  <form className="bg-white shadow-lg rounded px-8 py-8 mb-4 flex flex-col items-start">
  <MdOutlineMobileFriendly size={40} className="text-blue-900" />
    ...
    <div className='flex gap-6'>
      ...
      {loader && <svg aria-hidden="true" class="inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-pink-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
